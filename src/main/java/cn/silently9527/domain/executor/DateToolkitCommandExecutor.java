...
import cn.silently9527.ui.DateUI;
...
public class DateToolkitCommandExecutor extends AbstractToolkitCommandExecutor {
    private static final String POPUP_TITLE = "Date";

    @Override
    public boolean support(ToolkitCommand command) {
        return ToolkitCommand.Date.equals(command);
    }
    ...
    public void execute(ToolkitCommand command, DataContext dataContext) {
        ...
        JPanel panel = new DateUI(project).getPanel();
