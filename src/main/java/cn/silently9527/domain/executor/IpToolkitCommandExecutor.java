...
public class IpToolkitCommandExecutor extends AbstractToolkitCommandExecutor {
    private static final String POPUP_TITLE = "IP Address Search";

    @Override
    public boolean support(ToolkitCommand command) {
        return ToolkitCommand.IP.equals(command);
    }
    ...
    public void execute(ToolkitCommand command, DataContext dataContext) {
        ...
        JPanel panel = new IPAddressUI(project).getPanel();
