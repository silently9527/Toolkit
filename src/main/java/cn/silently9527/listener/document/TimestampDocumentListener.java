...
public class TimestampDocumentListener implements DocumentListener {
    ...
    public TimestampDocumentListener(EditorTextField textField,
    ...
    public void documentChanged(@NotNull DocumentEvent event) {
        ...
        try {
            DateTime dateTime = new DateTime(Long.valueOf(text));
